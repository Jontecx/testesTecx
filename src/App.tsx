...
const Hero = () => {
  return (
    <section id="inicio" className="relative h-screen flex items-center overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-[0.05] select-none pointer-events-none p-10 md:p-20">
        <div className="w-full max-w-2xl aspect-square flex items-center justify-center">
           <img 
             src="/logo.png" 
             alt="Logo Dra. Ticiane Carvalho" 
             className="w-full max-w-[80%] h-auto object-contain grayscale brightness-0"
