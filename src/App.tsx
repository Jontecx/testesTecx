...
const Hero = () => {
  return (
    <section id="inicio" className="relative h-screen flex items-center overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 flex items-center justify-center md:justify-end opacity-[0.08] md:opacity-[0.15] select-none pointer-events-none p-10 md:pr-40">
