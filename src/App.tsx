      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-stretch gap-16 lg:gap-24">
          ...
          >
            ...
            <div className="relative flex-grow min-h-[600px] lg:min-h-0 overflow-hidden shadow-2xl">
              <img 
                src="/image.png" 
              ...
              {/* Bottom Overlay Name */}
              <div className="absolute bottom-0 left-0 w-full pt-32 pb-12 px-8 z-10 text-center lg:text-left bg-gradient-to-t from-white/90 via-white/40 to-transparent">
                <h2 className="text-3xl min-[375px]:text-4xl md:text-5xl lg:text-6xl font-serif text-brand-primary leading-tight">
                  Dra. Ticiane <span className="text-brand-primary/40">Carvalho</span>
                </h2>
                <div className="w-20 h-px bg-brand-primary mt-6 mx-auto lg:mx-0"></div>
              </div>
            </div>
          </motion.div>
          ...
          >
            {/* Column content starts with the description points */}
            <div className="space-y-6 min-[375px]:space-y-8 text-base min-[375px]:text-lg text-brand-text/80 leading-relaxed font-light mt-10 md:mt-0">
