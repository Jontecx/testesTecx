...
const NewHero = () => {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center pt-40 pb-32 overflow-hidden bg-brand-bg">
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-20 lg:gap-32">
          ...
          <motion.div 
            ...
            className="lg:w-1/2 space-y-16 text-center lg:text-left order-2 lg:order-1"
          >
            <div className="space-y-6">
              <h1 className="text-6xl md:text-9xl font-bold tracking-tighter text-brand-primary leading-[0.9]">
                Dra. Ticiane <br /> <span className="text-brand-secondary">Carvalho</span>
              </h1>
              <div className="w-24 h-px bg-brand-secondary mx-auto lg:mx-0"></div>
            </div>

            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-6">
                <h4 className="text-brand-primary text-[10px] uppercase tracking-[0.4em] font-black opacity-60">Formação Acadêmica</h4>
                <div className="space-y-4 text-lg text-brand-text/80 leading-relaxed font-light">
            ...
            <div className="space-y-8">
              ...
              <div className="flex justify-center lg:justify-start gap-8 text-brand-primary/40">
          ...
          >
            <div className="relative w-full max-w-[550px] aspect-[4/5] flex items-center justify-center bg-brand-accent/20 border border-brand-secondary/30 rounded-[3rem] lg:rounded-[4rem] overflow-hidden p-6 lg:p-10">
              <img 
                src="/image.png" 
                alt="Dra. Ticiane Carvalho" 
                className="w-full h-full object-contain lg:object-cover rounded-[2rem] lg:rounded-[2.5rem] shadow-2xl shadow-brand-primary/5"
