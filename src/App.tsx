    ...
    <header className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-white/95 backdrop-blur-md shadow-md py-4" : "bg-transparent py-6"}`}>
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <a href="#inicio" className="flex flex-col group overflow-hidden">
          ...
          <span className={`text-[8px] min-[375px]:text-[10px] uppercase tracking-[0.3em] min-[375px]:tracking-[0.4em] font-medium transition-colors text-brand-primary/60`}>Hematologista</span>
        </a>
  ...
  return (
    <div className="fixed right-4 top-1/2 -translate-y-1/2 z-[60] flex flex-col gap-4 lg:hidden">
      <button 
        ...
        className="w-12 h-12 bg-white/80 backdrop-blur-md border border-brand-primary/20 rounded-full flex items-center justify-center text-brand-primary shadow-lg active:scale-90 transition-transform"
...
const Hero = () => {
  return (
    <section id="inicio" className="relative h-screen flex items-center overflow-hidden bg-white">
      {/* Background Logo Container (Placeholder for Empresa Logo) */}
      <div className="absolute inset-0 flex items-center justify-center opacity-[0.03] select-none pointer-events-none p-10 md:p-20">
        <div className="w-full max-w-2xl aspect-square flex items-center justify-center border-[20px] border-brand-primary rounded-full">
           <span className="text-brand-primary font-serif text-[150px] md:text-[250px] font-black">TC</span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full pt-20 text-center md:text-left">
        ...
        >
          <div className="space-y-4">
            <span className="text-brand-primary/60 text-[10px] min-[375px]:text-xs uppercase tracking-[0.4em] min-[375px]:tracking-[0.6em] font-black block">Hematologia Especializada</span>
            <h1 className="text-4xl min-[375px]:text-5xl md:text-8xl font-black tracking-tighter text-brand-primary leading-tight md:leading-none">
              A Essência da <span className="text-brand-text/30">Vida no Sangue</span>
            </h1>
          </div>
...
const AboutSection = () => {
  return (
    <section id="sobre" className="section-padding bg-brand-accent/30">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="w-full lg:w-1/2 space-y-8 min-[375px]:space-y-12"
          >
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          <div className="lg:w-1/3">
            ...
            <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="btn-primary w-full lg:w-auto">
          ...
          <div className="lg:w-2/3 grid md:grid-cols-2 gap-6">
            {symptoms.map((symptom, idx) => (
              <motion.div 
                ...
                className="bg-brand-accent/20 p-8 rounded-2xl border-l-4 border-brand-primary flex gap-4 card-hover"
              >
        ...
        <div className="grid md:grid-cols-2 gap-20 items-center">
          <div className="space-y-12">
            ...
            <div className="space-y-8 min-[375px]:space-y-10">
              <div className="flex items-start gap-4 min-[375px]:gap-6 group hover:translate-x-2 transition-transform duration-300">
                <div className="p-2 min-[375px]:p-3 bg-brand-accent/30 rounded-lg text-brand-primary shrink-0">
                  <ExternalLink size={20} className="min-[375px]:w-6 min-[375px]:h-6" />
                </div>
                <div>
                  <h3 className="text-xl min-[375px]:text-2xl font-serif mb-2">Clínica Cury Vascular</h3>
              ...
              <div className="flex items-start gap-4 min-[375px]:gap-6 group hover:translate-x-2 transition-transform duration-300">
                ...
                <div>
                  <h3 className="text-xl min-[375px]:text-2xl font-serif mb-2">Waken Clínica</h3>
                  <p className="text-sm min-[375px]:text-base text-brand-text/60 font-light leading-relaxed">
          ...
          <div id="contato-agendar" className="bg-brand-accent/30 p-8 min-[375px]:p-12 rounded-[2rem] min-[375px]:rounded-[3rem] border border-brand-secondary/50 space-y-8 min-[375px]:space-y-10 text-center">
            ...
            <div className="space-y-4 pt-4 min-[375px]:pt-6">
              ...
              <a href="mailto:draticianecarvalho@gmail.com" className="text-base min-[375px]:text-lg font-medium text-brand-text/80 hover:text-brand-primary break-all">
